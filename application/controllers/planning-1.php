...
class Planning extends CI_Controller {
    ...
    */
    ...
    public function index() {
		...
		$data['dsFullPlanning'] = null;
		$data['diffStartCurrentDate'] = 0;
		$data['totalSlotDate'] = 10;
	...
	public function view() {
    	...
    	if ($this->input->server('REQUEST_METHOD') === 'POST') {
			...
			$userData['level'] = $this->session->userdata('level');
			$data = $this->getInitialDataToDisplay();
			$data['dsFullPlanning'] = $dsFullPlanning;
			$data['diffStartCurrentDate'] = $diffStartCurrentDate;
			$data['totalSlotDate'] = $totalSlotDate;
