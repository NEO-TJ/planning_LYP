...
class Stock_m extends CI_Model {
    ...
    */
    ...
    /**
     * Count row of step by job_id && step_id
     * @param int $jobID, stepID
     * @return array
     */
    ...
    /**
     * Update stock (Adjust stock)
     * @param array $FK_ID_Job, $FK_ID_Step, $data($qtyOK or $qtyOKFirstStep) - associative array with data to store
     * @return boolean
     */
...
//		$sql = $this->db->last_query();
    ...
    */
    ...
    /**
    * Delete stock
    * @param int $jobID, $arrStepID - job id and array step id
    * @return boolean
    */
