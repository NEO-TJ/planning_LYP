		...
		-->
 		...
 		<?php 
			echo js_asset('jquery.min.js');
 			...
 			echo js_asset('bootstrap/bootstrap.js');
			...
			echo js_asset('job/multiFilter.js');
			echo js_asset('job/modalConfirm.js');
			echo js_asset('job/jobRemove.js');
		?>
	</body>
</html>